...
type Config struct {
	...
	FsEndpoint       string        `env:"STORAGE_ENDPOINT"`
	FsBucket         string        `env:"STORAGE_BUCKET"`
	FsAccessKey      string        `env:"STORAGE_ACCESS_KEY"`
	FsSecretKey      string        `env:"STORAGE_SECRET_KEY"`
}
